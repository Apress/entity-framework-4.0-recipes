...
namespace Recipe11
{
    ...
    [KnownTypeAttribute(typeof(MiddleClass))]
    [KnownTypeAttribute(typeof(UpperClass))]
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="EFRecipesModel", Name="MiddleClass")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class MiddleClass : Member
    {
        #region Factory Method
    
        /// <summary>
        /// Create a new MiddleClass object.
        /// </summary>
        /// <param name="memberId">Initial value of the MemberId property.</param>
        /// <param name="name">Initial value of the Name property.</param>
        public static MiddleClass CreateMiddleClass(global::System.Int32 memberId, global::System.String name)
        {
            MiddleClass middleClass = new MiddleClass();
            middleClass.MemberId = memberId;
            middleClass.Name = name;
            return middleClass;
        }
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="EFRecipesModel", Name="UpperClass")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class UpperClass : Member
    {
        #region Factory Method
    
        /// <summary>
        /// Create a new UpperClass object.
        /// </summary>
        /// <param name="memberId">Initial value of the MemberId property.</param>
        /// <param name="name">Initial value of the Name property.</param>
        public static UpperClass CreateUpperClass(global::System.Int32 memberId, global::System.String name)
        {
            UpperClass upperClass = new UpperClass();
            upperClass.MemberId = memberId;
            upperClass.Name = name;
            return upperClass;
        }
